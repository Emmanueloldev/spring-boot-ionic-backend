...
public class CategoriaResource {
	...
	public ResponseEntity<Void> update(@Valid @RequestBody CategoriaDTO objDto, @PathVariable Integer id){  // retorna um corpo vazio quando a atualizaçao ocorrer com sucesso, chamamos de update
		Categoria obj = service.fromDTO(objDto);
